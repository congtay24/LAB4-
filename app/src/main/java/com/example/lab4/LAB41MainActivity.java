...
public class LAB41MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt1 = findViewById(R.id.lab41Txt1);
        txt2 = findViewById(R.id.lab41Txt2);
        txt3 = findViewById(R.id.lab41Txt3);
        btnInsert=findViewById(R.id.lab41Btn1);
        btnGet=findViewById(R.id.lab41Btn2);
        tvKQ=findViewById(R.id.lab41TvKQ);
